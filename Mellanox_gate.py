...
# try:
# creating Dataframe
EL = sch_check("Mellanox(497) Package CES v1.2.xlsm","Turnkey schedule","Main Lot#/DCC", device_column="Main Tdevice",po_column="PO#",datecode_column="Date Code", current_fg_column="Main EL FG/PV")
...
EL.get_info(['test_device', 'test_po', 'date_code', 'current_fg'])
EL.comparing('EL')
 q
